...
if choice == '1':
    ...
    print("You chose to train on Sentinel-1 only.")
    print("Do you want to manually set the hyperparameters for Sentinel-1 ? (y/n)")
    manual_s1 = input("Enter your choice: ")
    if manual_s1 == 'y':

        s1_epochs = int(input("Enter the number of epochs for Sentinel-1: "))
        S1_SUBSET_SIZE = int(input("Enter the subset size for Sentinel-1: (default 5000 put 0 for all) "))
        if S1_SUBSET_SIZE == 0:
    ...
    os.makedirs("./logs/sent2", exist_ok=True)
    ...
    print("You chose to train on Sentinel-2 only.")
    print("Do you want to manually set the hyperparameters for Sentinel-2 ? (y/n)")
    manual_s2 = input("Enter your choice: ")
    if manual_s2 == 'y':
        s2_epochs = int(input("Enter the number of epochs for Sentinel-2: "))
        S2_SUBSET_SIZE = int(input("Enter the subset size for Sentinel-2: (0 for all) "))
        if S2_SUBSET_SIZE == 0:
    ...
    os.makedirs(s1_save_dir, exist_ok=True)
    os.makedirs(s2_save_dir, exist_ok=True)
    os.makedirs("./logs/sent1", exist_ok=True)
    os.makedirs("./logs/sent2", exist_ok=True)
    ...
    print("You chose to train on both Sentinel-1 and Sentinel-2.")
    print("Do you want to manually set the hyperparameters for Sentinel-1 and Sentinel-2 ? (y/n)")
    manual_both = input("Enter your choice: ")
    if manual_both == 'y':
        s1_epochs = int(input("Enter the number of epochs for Sentinel-1: "))
        S1_SUBSET_SIZE = int(input("Enter the subset size for Sentinel-1: (default 5000 put 0 for all) "))
        if S1_SUBSET_SIZE == 0:
        ...
        s2_epochs = int(input("Enter the number of epochs for Sentinel-2: "))
        S2_SUBSET_SIZE = int(input("Enter the subset size for Sentinel-2: (default all) "))
        if S2_SUBSET_SIZE == 0:
            S2_SUBSET_SIZE = len(sent2_metadata)
...
def evaluate_model(val_df, dataset, model, is_s2=False,
                   max_viz=5, max_eval=100,
    ...
    print(f"\nBest threshold for {dataset}: {best['Threshold']}")
    print(f"\nSaving visualizations only for best threshold {best['Threshold']}...")
    ...
    for _, row in val_df.head(max_viz).iterrows():
        ...
        fig.savefig(
            f"{visualization_dir}/{dataset}_{tile_id.split('.')[0]}.png",
            dpi=100,
            bbox_inches='tight'
        )
